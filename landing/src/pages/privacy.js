...
const PrivacyPolicy = () => (
  <>
    ...
    <div className={styles.p1} style={{ height: "auto" }}>
      ...
      >
        <p>
          At kord, accessible from www.kord.app, one of our main priorities is
          the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by kord and how we
          use it.
        </p>
        <p>
        ...
        <p>
          ...
          advertisements and links that appear on kord, which are sent directly
