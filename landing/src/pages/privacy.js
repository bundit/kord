...
const PrivacyPolicy = () => (
  <div className={styles.p1} style={{ height: "auto" }}>
    ...
    <div
      className={styles.p2}
      style={{ textAlign: "left", padding: "20px", boxSizing: "border-box" }}
    >
      <p>
        At kord, accessible from www.kord.app, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by kord and how we use it.
      </p>
      <p>
      ...
      <p>
        www.kord.app legal basis for collecting and using the personal
      ...
      <ul>
        <li>www.kord.app needs to perform a contract with you</li>
        <li>You have given www.kord.app permission to do so</li>
        <li>
          Processing your personal information is in www.kord.app legitimate
          interests
        </li>
        <li>www.kord.app needs to comply with the law</li>
      </ul>
      <p>
        www.kord.app will retain your personal information only for as long as
      ...
      >
        <div>
          ...
          <ul>
            <li>
              <h3>Spotify widget and YouTube video widget</h3>
      ...
      <h2>Log Files</h2>
      <p>
        kord follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, kord uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of kord.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on kord, which are sent directly to
      ...
      <p>
        Note that kord has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        kord's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        kord does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in kord. This policy is not applicable to any
